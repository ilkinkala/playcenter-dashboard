...
import { Clock, LogOut, AlertTriangle, TimerOff, Phone, Pencil, Check } from 'lucide-react';
import { calculateProratedPrice, formatPrice, getTolerance } from '../utils/pricing';
...
export default function TimerCard({ child, onTimeUp, onComplete, onUpdatePhone }) {
  ...
  function getElapsedMinutes() {
    const elapsed = Date.now() - child.startTime;
  ...
  return (
    <div className={`timer-card ${urgency}`}>
      <div className="timer-card-header">
        ...
        <div className="package-badge">{child.packageLabel}</div>
      </div>
